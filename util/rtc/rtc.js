...
let Store = {
  ...
  // 对方网络异常定时器（10s后关闭通话）
  networkAnomaly: null,
  networkAnomalyTime: 30000,
  // 加入频道后，频道无其他用户，通话异常定时器
  joinChannelUser: null,
  joinChannelUserTime: 30000,
};
// rtc 实时音频通话
const RTC = {
  // 初始化
  init: async function(etAudioAiNoise) {
    ...
    */
    await rtcModule.setParameters({
      Cmd: 'ConfPriCloudAddr',
      ServerAdd: "linkgapie.com",
      Port: 6080,
    }, (res) => {
