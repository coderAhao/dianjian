<template>
	<view class="content_bg" :style="{width: windowWidth + 'px',height: windowHeight + 'px'}">
		...
		<view class="nav">
			<!-- 返回 -->
			<image src="/static/rtc/icon_return_w.png" mode="" style="height: 16px;width: 10px;" @click="callBack">
			</image>
			<text class="text_color">点对点呼叫邀请</text>
			<image src="/static/rtc/icon_set.png" mode="" style="width: 16px;height: 16px;" @click="setPage"></image>
		</view>
		<view class="content">
...
<script>
	import ValidCode from '../../components/rtc/validCode.vue'
	export default {
		components: {
			ValidCode
		},
